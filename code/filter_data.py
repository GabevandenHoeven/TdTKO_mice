...
def filter_tcrb_generated_data(rtcr_ref: dict, tcrb_data_filenames, max_sequence_size, flt_strain,
    ...
    """
    outlines = [
        "Column1\tV.length.used\tD.used\tD.length.used\tJ.length.used\tV.length.deleted\t"
...
if __name__ == '__main__':
    ...
    pheno = 'Generated'
    files = [
        f'..\\data_files\\B6\\filtered_data\\generated_data_Normal.tsv'
    ]
    ...
    files = [
        f'..\\data_files\\TdTKo\\filtered_data\\generated_data_TdTKO.tsv'
    ]
