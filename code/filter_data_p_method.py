...
def filter_sequences_with_insertions(in_filename: str, out_filename: str, delim='\t'):
    """This function reads a datafile of CDR3 nt sequences and writes all lines with sequences that have inferred
    insertions to a new TSV file.

    :param in_filename: The filepath to the datafile with the sequence information.
    :param out_filename: The filepath to the output file. This file does not have to exist already.
    :param delim: The delimiter of the input datafile.
    :return:
    """
    outfile_lines = []
